...
# def run_and_save_sir_model(graph_func, graph_name, graph_args=[], beta=0.1, gamma=0.01, fraction_infected=0.1, steps=10):
#     G, config = graph_func(*graph_args)  # Unpack graph-specific arguments
...
#     print(f"{graph_name} iterations:", iterations)
...
#     # Save the plot
#     plt.savefig(f'graph_infected_state_{graph_name}.png', format='PNG')
#     plt.close()

# # List of graph functions, their names, and specific arguments
# graphs = [
#     (connSW, "connSW", [50, 0.1]),  # connSW requires the number of nodes and beta value
#     (BA, "BA", []),
#     (ER, "ER", []),
#     (CiteSeer, "CiteSeer", []),
#     (PubMed, "PubMed", []),
...
# # Run and save for each graph type
# for graph_func, graph_name, graph_args in graphs:
#     run_and_save_sir_model(graph_func, graph_name, graph_args)
...
# # List of graph functions, their names, and specific arguments
# graphs = [
#     (connSW, "connSW", [1000, 0.1]),  # connSW requires the number of nodes and beta value
#     (BA, "BA", []),
#     (ER, "ER", []),
#     (CiteSeer, "CiteSeer", []),
#     (PubMed, "PubMed", []),
